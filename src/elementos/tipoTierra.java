...
public class tipoTierra extends Pokemon{
    //Atributos
    ...
    public tipoTierra(String n_ataque1, String n_ataque2, String n_ataqueE, String nombre, int id) {
        super(nombre, "Tierra", id);
    ...
    public String toString() {
        return super.toString()+"\nAtaque 1:" + n_ataque1 + "\tAtaque 2: " + n_ataque2 + 
                "\nAtaque especial (3): " + n_ataqueE + "\tAtaque psiquico: " + "\nDebilidad: " + debilidad +"\n";
    }
